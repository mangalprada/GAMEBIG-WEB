...
const EventTabs = () => {
  ...
  return (
    <div
      className="md:w-2/3 xl:w-1/2 my-2 mx-2 md:mx-auto 
    text-gray-300 font-bold font-sans text-sm sm:text-lg flex items-center justify-evenly"
    >
      <Link href={'/explore'} passHref>
        <span
          className={
            'cursor-pointer py-1 px-6 mx-0.5 sm:px-12 md:px-20 rounded w-1/2 flex justify-center items-center gap-1 md:gap-4 ' +
      ...
      <Link href={'/explore/gamers'} passHref>
        <span
          className={
            'cursor-pointer py-1 px-10  mx-0.5 sm:px-12 md:px-20 rounded w-1/2 flex justify-center items-center gap-1 md:gap-4 ' +
