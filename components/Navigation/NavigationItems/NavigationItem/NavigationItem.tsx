      ...
      <div className="flex flex-col justify-center">
        <div className="relative sm:max-w-xl sm:mx-auto">
          <div className="group cursor-pointer relative inline-block w-28 text-center">
            ...
            <div className="opacity-0 w-28 bg-gray-900 text-gray-300 text-center text-xs rounded-lg py-2 absolute z-10 group-hover:opacity-100 top-14 -left-1/2 ml-14 px-3 pointer-events-none">
              Tooltip center
            </div>
          </div>
        </div>
